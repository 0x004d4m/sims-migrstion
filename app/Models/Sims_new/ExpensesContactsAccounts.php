...
class ExpensesContactsAccounts extends Model
{
	use HasFactory;
	protected $table = 'expenses_contacts_accounts';

	protected $connection = 'sims_new';

	protected $fillable = ['id','location_id','expenses_category_id','expenses_mode_id','assigned_user_id','tenant_id','organisation_id','currency_id','starting_balance','starting_balance_date','first_name','last_name','description','tax_free','primary_email','primary_mobile','primary_phone','primary_fax','website','brand_name','tax_number','tax_rate','active','created_at','updated_at','account_number','u_id'];

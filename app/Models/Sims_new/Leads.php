...
class Leads extends Model
{
	...
	protected $fillable = ['id','tenant_id','location_id','assigned_user_id','lead_source_id','lead_status_id','email','phone','mobile_number','fax','job_title','website','description','created_at','updated_at','is_converted','payload','u_id','first_name','last_name','organisation_name'];
